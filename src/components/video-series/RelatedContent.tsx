          ...
          return (
            ...
            >
              <div className="h-full w-full relative">
                ...
                <h4 className="absolute bottom-8 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-xl font-semibold flex flex-col items-center">
                  Video Series ({item?.coursesCount})
                  <ArrowRightAlt className="w-0 group-hover:w-full common-transition" />
                </h4>
                <img src={imageUrl} className="rounded-lg  common-transition" />
                <img
