...
const PropertyCard = () => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-sm mx-auto box-border p-10 h-[15rem]">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-600 mb-4">
          Soon you can invest in Sydhavnen's new attractive neighborhoods. With neighborhoods like Havneh, Teglholmens and Soon you can invest in Sydhavnen's new attractive neighborhoods. With neighborhoods like Havneh, Teglholmens and Sluseholmen we look at many investment opportunities.
        </p>
